        ...
        if self.config.dataset == 'gsm8kinstruct_question':
            if self.config.target_lang == 'all':
                ...
                for target_lang in lang_pool:
                    ...
                    source_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_question/en-{}/train.{}'.format(target_lang, self.config.source_lang)
                    target_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_question/en-{}/train.{}'.format(target_lang, target_lang)
                ...
                for source_lang in lang_pool:
                    ...
                    source_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_question/{}-{}/train.{}'.format(source_lang, target_lang, source_lang)
                    target_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_question/{}-{}/train.{}'.format(source_lang, target_lang, target_lang)
            ...
            if self.config.target_lang == 'all':
                ...
                for target_lang in lang_pool:
                    ...
                    source_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_answer/en-{}/train.{}'.format(target_lang, self.config.source_lang)
                    target_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_answer/en-{}/train.{}'.format(target_lang, target_lang)
                ...
                for source_lang in lang_pool:
                    ...
                    source_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_answer/{}-en/train.{}'.format(source_lang, source_lang)
                    target_path='/home/dangrf/QAlign/data/gsmtrans/gsm8kinstruct_answer/{}-en/train.{}'.format(source_lang, self.config.target_lang)
